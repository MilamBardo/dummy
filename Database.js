...
client4.connect();
var query4 = client4.query('CREATE TABLE public.imageinfos(imageid SERIAL PRIMARY KEY, imagename character varying(200) NOT NULL, imagefilepath character varying(200) NOT NULL,  imagealt character varying(200) NOT NULL, datecreated timestamp without time zone NOT NULL);');
query4.on('end', function() { client4.end(); });

var client5 = new pg.Client(connectionString);
client5.connect();
var query5 = client5.query('CREATE TABLE public.galleryimages(galleryimageid SERIAL PRIMARY KEY, galleryid integer NOT NULL, imageid integer NOT NULL, galleryimageordernumber integer NOT NULL, galleryimagecaption character varying(200) NOT NULL,sizecontrollingdimension character varying(20) NOT NULL, sizecontrollingpercentage character varying(100) NOT NULL,  datecreated timestamp without time zone NOT NULL);');
query5.on('end', function() { client5.end(); });

var client6 = new pg.Client(connectionString);
client6.connect();
var query6 = client6.query('CREATE TABLE public.postimages(postimageid SERIAL PRIMARY KEY, postid integer NOT NULL, imageid integer NOT NULL, postimagecaption text NULL,  sizecontrollingdimension character varying(20) NOT NULL, sizecontrollingpercentage character varying(100) NOT NULL, imagetype character varying(50) NOT NULL, imagetypeorder integer NOT NULL, datecreated timestamp without time zone NOT NULL);');
